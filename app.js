...
<img src="https://heckfree.cyclic.app/img/logo.png" style="width:40px;border-radius:60%;float:left;">
</a>
<br>
<br>
  ...
  <p>
  <a target="_blank" style="text-decoration:none; background-color: black; border: black 1px solid; color: #fff; padding:10px 10px; display:block;" href="https://heckfree.cyclic.app/resetpassword/${token}">
  <strong>Reset Password</strong></a>
  </p>
  <p style="text-align:left">This link can only be used once. If you need to reset your password again, please visit <a href="https://heckfree.cyclic.app">https://heckfree.cyclic.app/</a> and request another reset.<br><br>If you did not make this request, you can simply ignore this email.</p>
